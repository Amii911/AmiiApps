...
const PREVIEW_ROWS = [
  ...
  { title: "Explain async/await in JS", source: "Phone Interview", difficulty: "Easy",   status: "todo",      topic: "JavaScript" },
  { title: "Merge K Sorted Lists",      source: "On-site",         difficulty: "Hard",   status: "todo",      topic: "Linked Lists" },
];
  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg-page)]">
      ...
      <div className="max-w-5xl mx-auto px-6 pt-20 pb-16 text-center">
        <div className="inline-flex items-center gap-2 bg-[var(--color-bg-card)] border border-[var(--color-border)] rounded-full px-4 py-1.5 mb-8">
        ...
        <h1 className="text-5xl sm:text-6xl font-bold tracking-tight text-[var(--color-text-primary)] leading-none mb-6">
          Track every<br />
        ...
        <p className="text-lg text-[var(--color-text-secondary)] max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          Log questions from any source — coding platforms, company screens, system design rounds, and more.
        </p>
          ...
          <div className="grid grid-cols-4 gap-0 border-b border-[var(--color-border)]">
            {[
              ...
              <div key={s.label} className={`px-5 py-3 ${i < 3 ? "border-r border-[var(--color-border)]" : ""}`}>
                ...
                <p className="text-xl font-bold font-mono leading-none" style={{ color: s.color }}>{s.value}</p>
              </div>
            ))}
          </div>
